...
- Added `runtime/room_transition_decision_aligned_monitor_cli.js` to re-anchor evidence capture to the approval decision path, which reliably emits fresh `approval_resolved` office movement intents from queue truth.
