...
function renderBrief(checkpoint, trend, freshness) {
  ...
  return [
    ...
    `- freshest_intent_trigger_timestamp: ${freshestIntent ? freshestIntent.trigger_timestamp || "n/a" : "n/a"}`,
    ...
    `- freshness_gap_minutes: ${freshestIntent ? freshestIntent.freshness_gap_minutes ?? "n/a" : "n/a"}`,
